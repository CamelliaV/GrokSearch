...
class GrokSearchProvider:
    def __init__(self, api_url: str, api_key: str, model: str = "grok-4-fast", client: httpx.AsyncClient | None = None):
        ...
        async for attempt in AsyncRetrying(
            ...
            with attempt:
                if client and not client.is_closed:
                    ...
                    async with httpx.AsyncClient(timeout=timeout, follow_redirects=True) as temp_client:
